...
<div class="col-12 col-xl-12">
    <div class="card">
        <div class="card-body p-4">
            <h5 class="mb-4">Add kasir</h5>
            <form class="row g-3" method="POST" action="{{ route('kasir.store') }}">
                @csrf
                <div class="col-md-4x">
                    <label for="input13" class="form-label">Nama Lengkap</label>
                    <div class="position-relative">
                        <input type="text" name="nama_kasir" class="form-control @error('name') is-invalid @enderror" id="input13" value="{{ old('name') }}" placeholder="Nama Lengkap" required>
                        @error('name')
                ...
                <div class="col-md-12">
                    <div class="d-md-flex d-grid align-items-center gap-3">
                        <a href="{{route('kasir.index')}}" class="btn btn-grd-danger px-4">Cancel</a>
