    ...
    <div class="col-12 col-lg-4 d-flex" style="margin-left:-1rem;margin-top: -1rem">
        <div class="w-100">
            <div class="card">
                ...
                {{-- modal pembayaran--}}
                <div class="modal fade" id="BayarModal" aria-labelledby="exampleModalLabel" aria-hidden="true" onclick="tampilkanDetailPesanan()">
                                ...
                                <div class="modal-body">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <h5 class="mb-0 fw-bold">
                                                <input class="inputan mb-3" type="text" name="subtotal" id="detailSubtotal" placeholder="Rp. 0">
                                            </h5>
                                        </div>
                                        <div class="d-flex justify-content-between">
                                            <h5 class="mb-0 fw-bold">Pajak</h5>
                                            <h5 class="mb-0 fw-bold">
                                                <input class="inputan mb-3" type="text" name="pajak" id="detailPajak" placeholder="Rp. 0">
                                            </h5>
                                        </div>
                                        <hr>
                                        <div class="d-flex justify-content-between">
                                            <h5 class="mb-0 fw-bold">Total :</h5>
                                            <h5 class="mb-0 fw-bold">
                                                <input class="inputan mb-3" type="text" name="total" id="detailTotal" placeholder="Rp. 0">
                                            </h5>
                                        </div>
                                        <hr>
                                        ...
                                        <div class="d-flex justify-content-between pt-4">
                                            ...
                                            <h5 class="mb-0 fw-bold">
                                                <input class="inputan mb-3" type="text" name="kembali" id="kembalian" placeholder="Rp. 0">
                                            </h5>
                                        </div>
                                        <hr>
                                        <div class="d-flex ">
