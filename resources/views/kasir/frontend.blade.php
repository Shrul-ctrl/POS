                                            ...
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <h5 class="mb-0 fw-bold">
                                                        <input class="form-control mb-3" type="text" name="menu" id="detailMenu" placeholder="Rp. 0">
                                                    </h5>
                                                </div>
                                                <hr>
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <h5 class="mb-0 fw-bold">
                                                        <input class="form-control mb-3" type="text" name="subtotal" id="detailSubtotal" placeholder="Rp. 0">
                                                    </h5>
                                                </div>
                                                <div class="d-flex justify-content-between">
                                                    <h5 class="mb-0 fw-bold">Pajak</h5>
                                                    <h5 class="mb-0 fw-bold">
                                                        <input class="form-control mb-3" type="text" name="pajak" id="detailPajak" placeholder="Rp. 0">
                                                    </h5>
                                                </div>
                                                <hr>
                                                <div class="d-flex justify-content-between">
                                                    <h5 class="mb-0 fw-bold">Total :</h5>
                                                    <h5 class="mb-0 fw-bold">
                                                        <input class="form-control mb-3" type="text" name="total" id="detailTotal" placeholder="Rp. 0">
                                                    </h5>
                                                </div>
                                                <hr>
                                                ...
                                                <div class="d-flex justify-content-between pt-4">
                                                    ...
                                                    <h5 class="mb-0 fw-bold">
                                                        <input class="form-control mb-3" type="text" name="kembali" placeholder="Rp. 0">
                                                    </h5>
                                                </div>
                                            </div>
                                        </div>
